...
Version  : 2.16.0
Release  : 45
URL      : https://files.pythonhosted.org/packages/57/d8/ee798677aaa9a9d1f0c7fbf8a243fc297d51d5905c3feecccb54f8d9f74c/imageio-2.16.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/57/d8/ee798677aaa9a9d1f0c7fbf8a243fc297d51d5905c3feecccb54f8d9f74c/imageio-2.16.0.tar.gz
...
%prep
%setup -q -n imageio-2.16.0
cd %{_builddir}/imageio-2.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644862146
...
cp %{_builddir}/imageio-2.16.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-imageio/c3f3ee58b67ca6a8d73f562dd42eda4e897eb1c0
