...
Source0  : https://files.pythonhosted.org/packages/cc/d0/86ba50eccd9e2e88fe5c5dc3ae23d7871e2c879f24a0e7fc947b5b726451/imageio-2.19.0.tar.gz
...
%prep
%setup -q -n imageio-2.19.0
cd %{_builddir}/imageio-2.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651522902
