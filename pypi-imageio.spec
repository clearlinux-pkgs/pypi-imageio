...
Version  : 2.24.0
Release  : 77
URL      : https://files.pythonhosted.org/packages/06/f7/183406991b21614edd35e4469b4988c06344d000ae2c2acb2bd67c27c76a/imageio-2.24.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/06/f7/183406991b21614edd35e4469b4988c06344d000ae2c2acb2bd67c27c76a/imageio-2.24.0.tar.gz
...
%prep
%setup -q -n imageio-2.24.0
cd %{_builddir}/imageio-2.24.0
pushd ..
cp -a imageio-2.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673281565
