...
Version  : 2.21.2
Release  : 65
URL      : https://files.pythonhosted.org/packages/8e/15/8b99bb40218f7181a7d8a41674e5dc7f2c6602870a17703828aeec80322c/imageio-2.21.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/8e/15/8b99bb40218f7181a7d8a41674e5dc7f2c6602870a17703828aeec80322c/imageio-2.21.2.tar.gz
...
%prep
%setup -q -n imageio-2.21.2
cd %{_builddir}/imageio-2.21.2
pushd ..
cp -a imageio-2.21.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661792561
