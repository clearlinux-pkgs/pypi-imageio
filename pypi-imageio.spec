...
Source0  : https://files.pythonhosted.org/packages/2c/f9/aa9f3a4eae46f4727902516dc7b365356c1e4e883156532b74d135a69887/imageio-2.34.1.tar.gz
...
%prep
%setup -q -n imageio-2.34.1
cd %{_builddir}/imageio-2.34.1
pushd ..
cp -a imageio-2.34.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713807099
