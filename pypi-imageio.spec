...
Version  : 2.15.0
Release  : 44
URL      : https://files.pythonhosted.org/packages/4b/01/6d886211569a36d4941dabefa3768ee418a3951c0a4e500121dee9c4895b/imageio-2.15.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/4b/01/6d886211569a36d4941dabefa3768ee418a3951c0a4e500121dee9c4895b/imageio-2.15.0.tar.gz
...
%prep
%setup -q -n imageio-2.15.0
cd %{_builddir}/imageio-2.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644249672
...
cp %{_builddir}/imageio-2.15.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-imageio/c3f3ee58b67ca6a8d73f562dd42eda4e897eb1c0
