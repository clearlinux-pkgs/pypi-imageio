...
Version  : 2.19.5
Release  : 58
URL      : https://files.pythonhosted.org/packages/1e/fe/019a7b943dd1e6602cd395b87d005215dc8dae71dc4bfbbde7e47201861a/imageio-2.19.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/1e/fe/019a7b943dd1e6602cd395b87d005215dc8dae71dc4bfbbde7e47201861a/imageio-2.19.5.tar.gz
...
%prep
%setup -q -n imageio-2.19.5
cd %{_builddir}/imageio-2.19.5
pushd ..
cp -a imageio-2.19.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658155439
