...
Source0  : https://files.pythonhosted.org/packages/0c/47/57e897fb7094afb2d26e8b2e4af9a45c7cf1a405acdeeca001fdf2c98501/imageio-2.37.0.tar.gz
...
%prep
%setup -q -n imageio-2.37.0
cd %{_builddir}/imageio-2.37.0
pushd ..
cp -a imageio-2.37.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737387551
