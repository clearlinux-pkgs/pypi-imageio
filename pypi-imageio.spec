...
Source0  : https://files.pythonhosted.org/packages/70/aa/2e7a49259339e691ff2b477ae0696b1784a09313c5872700bbbdd00a3030/imageio-2.36.1.tar.gz
...
%prep
%setup -q -n imageio-2.36.1
cd %{_builddir}/imageio-2.36.1
pushd ..
cp -a imageio-2.36.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735096125
