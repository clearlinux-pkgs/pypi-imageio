...
Version  : 2.21.0
Release  : 60
URL      : https://files.pythonhosted.org/packages/0e/17/b56ccc0a0bddb1a49a579882d97a0d887d08fe320321fde4997d2b3e2274/imageio-2.21.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0e/17/b56ccc0a0bddb1a49a579882d97a0d887d08fe320321fde4997d2b3e2274/imageio-2.21.0.tar.gz
...
%prep
%setup -q -n imageio-2.21.0
cd %{_builddir}/imageio-2.21.0
pushd ..
cp -a imageio-2.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659367910
