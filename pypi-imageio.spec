...
Source0  : https://files.pythonhosted.org/packages/4f/34/a714fd354f5f7fe650477072d4da21446849b20c02045dcf7ac827495121/imageio-2.36.0.tar.gz
...
%prep
%setup -q -n imageio-2.36.0
cd %{_builddir}/imageio-2.36.0
pushd ..
cp -a imageio-2.36.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728916058
