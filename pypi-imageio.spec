...
Version  : 2.22.4
Release  : 73
URL      : https://files.pythonhosted.org/packages/b9/82/8134900c9e441127375c7578a2b1b2bbde7b3676436d5c4098ef4281c401/imageio-2.22.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/b9/82/8134900c9e441127375c7578a2b1b2bbde7b3676436d5c4098ef4281c401/imageio-2.22.4.tar.gz
...
%prep
%setup -q -n imageio-2.22.4
cd %{_builddir}/imageio-2.22.4
pushd ..
cp -a imageio-2.22.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667843169
