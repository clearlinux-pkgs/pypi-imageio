...
Version  : 2.34.2
Release  : 102
URL      : https://files.pythonhosted.org/packages/da/bd/d79206fe42f88d9a99ee952420eebc5368bcd062e17b484a21928462d98e/imageio-2.34.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/da/bd/d79206fe42f88d9a99ee952420eebc5368bcd062e17b484a21928462d98e/imageio-2.34.2.tar.gz
...
%prep
%setup -q -n imageio-2.34.2
cd %{_builddir}/imageio-2.34.2
pushd ..
cp -a imageio-2.34.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719249254
