...
Version  : 2.26.0
Release  : 80
URL      : https://files.pythonhosted.org/packages/3d/60/cd0c52c6f063d70727fd8ee885f87e2d3dff0243142a18eed5e2db969510/imageio-2.26.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/3d/60/cd0c52c6f063d70727fd8ee885f87e2d3dff0243142a18eed5e2db969510/imageio-2.26.0.tar.gz
...
%prep
%setup -q -n imageio-2.26.0
cd %{_builddir}/imageio-2.26.0
pushd ..
cp -a imageio-2.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677515529
